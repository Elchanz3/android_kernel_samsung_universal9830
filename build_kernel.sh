...
# Toolchains
BUILD_CROSS_COMPILE="/home/chanz22/tc/aarch64-zyc-linux-gnu-14/bin/"
KERNEL_LLVM_BIN="/home/chanz22/tc/Clang-14.0.6-20230207/bin/"
...
if [[ -f "$IMAGE" ]]; then
    ...
    mv "$OUT_DIR/dtb.img" "AnyKernel3/dtb.img"
